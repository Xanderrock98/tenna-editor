      ...
      clusters: [
        {
          ...
          flags: [
            ...
            'TALKED_TO_ASGORE_BEFORE_FESTIVAL',
            'ASGORE_HONEY_TOAST',
            'ATE_HONEY_TOAST',
            'SUSIES_OUTFIT_OPINION',
            'ADVENTURES_EXPLANATION',
          ],
        },
        {
          id: 'asgore',
          title: 'Asgore',
          flags: [
            'LISTENED_TO_ASGORES_SERIOUS_TOPIC',
            'TALKED_TO_ASGORE_FESTIVAL',
            'INTERACTED_WITH_MEWMEW_DOLL',
            'LOOKED_AT_ASGORES_ROSES',
            'TALKED_TO_ASGORES_FLOWERS',
          ],
        },
        {
          id: 'berdly',
          title: 'Berdly',
          flags: [
            'BERDLY_FESTIVAL_CUTSCENE',
            'BERDLY_POEM_LISTENED',
            'BERDLY_POEM_RESPONSE',
            'BERDLY_BROKEN_ARM_FESTIVAL',
          ],
        },
        {
          id: 'king-queen',
          ...
          flags: [
            'FESTIVAL_KING',
            'FESTIVAL_QUEEN',
            'SHOWED_KINGQUEEN_VOTE',
            'JOCKINGTON_GREW_THE_BEARD',
            'ASKED_CATTY_DAD_KINGQUEEN',
            'BERDLY_FESTIVAL_CUTSCENE',
          ],
        },
        {
          ...
          title: 'Ferris Wheel',
          flags: [
            'WHO_RODE_FERRIS_WHEEL',
            'KRIS_NOELLE_FERRIS_WHEEL_OUTCOME',
            'KRIS_NOELLE_FERRIS_WHEEL_CHOICE',
            'KRIS_SUSIE_FERRIS_WHEEL_CHOICE',
            'SUSIE_NOELLE_FERRIS_WHEEL_CHOICE',
          ],
        },
        {
          id: 'strength-tester',
          ...
          flags: [
            'STRENGTH_TESTER_NAPSTABLOOK',
            'STRENGTH_TESTER_DOGAMY',
            'STRENGTH_TESTER_DOGARESSA',
            'STRENGTH_TESTER_CHOICE',
            'STRENGTH_TESTER_NOELLE_TIMING',
          ],
        },
        {
          id: 'pizzapants',
        ...
        },
        {
          ...
          title: 'Other',
          flags: [
            'HOMETOWN_FESTIVAL_STATE',
            'SANS_PUNCH_CARD_DRAWING',
            'PLAYED_DUNK_TANK',
            'TALKED_TO_VULKIN',
            'SCARED_CHILD_RABBIT',
            'SUSIE_DINER_RESPONSE',
            'KNOCK_TOGETHER',
            'TRIED_GOING_HOME_DURING_FESTIVAL',
            'SUSIE_MENTIONED_JACKENSTEIN',
            'METTATON_HOUSE_VOICES',
            'SUGGESTED_TENNA_TO_METTATON_CH5',
            'LOOKED_IN_CATTI_HOUSE',
      ...
      clusters: [
        {
          ...
          title: 'Flower Cafe',
          flags: [
            'TALKED_TO_SODA_MACHINE',
            'BOUGHT_RAW_MOON',
            'BOUGHT_PHANTA',
            'BOUGHT_FLOWERY_SODA',
            'BOUGHT_SHIKA_COLA',
            'BOUGHT_FLOWERYS_SECRET',
            'FREE_DRINK_OUTCOME',
          ],
        },
        {
          ...
          flags: [
            'UNLOCKED_AQUA_BREAKS',
            'UNLOCKED_SETH_BREAKS',
            'UNLOCKED_YELLOW_BREAKS',
            'UNLOCKED_GREEN_BREAKS',
            'UNLOCKED_BLUE_BREAKS',
            'UNLOCKED_ORANGE_BREAKS',
            'UNLOCKED_PINK_BREAKS',
